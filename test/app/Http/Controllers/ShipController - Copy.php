    ...
    public function quotationcalculate(Request $request)
    {
        ...
        if ($input['quotation_status'] == 1) {
            ...
            if ($input['service_id'] == 1 || $input['service_id'] == 2 ) {
                ...
                $data = array( 'status' => 200, 'country'=>$input['country'], 'service_id'=> $input['service_id'], 'service_type'=> $input['service_type'], 'package_type'=>$input['package_type'], 'quotation_status' => $input['quotation_status'], 'result' => $booking_detail);
                return $data;
                ...
                $databtn = array( 'status' => 200, 'country'=>$input['country'], 'service_id'=> $input['service_id'], 'package_type'=>$input['package_type'], 'quotation_status' => $input['quotation_status'], 'result' => $booking_detail);
                return $databtn;
            }
