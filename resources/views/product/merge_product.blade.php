      ...
      <div class="row">
         ...
         <div class="col-lg-6 col-lg-4">
            <div class="form-group">
               ...
               <input type="number" class="form-control"  name="product_name" placeholder="Quantity" value="@if(!empty($order)){{ $order->item_quantity }}@endif"  required>
            </div>
         </div>
         <div class="col-md-12">
            <div class="form-group">
               <button type="submit" class="btn btn-adminsqure pull-right submitbutton"> Submit  <span class="spinner"></span></button>
            </div>
         </div>
      </div>
   </form>
